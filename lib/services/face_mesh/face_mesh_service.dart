...
class FaceMesh extends AiModel {
  ...
  Map<String, dynamic>? predict(image_lib.Image image) {
    ...
    //image = image_lib.Image(AssetImage('images/firas_front.png'));
    //image = image_lib.decodeImage(File('images/firas_front.png').readAsBytesSync())!;

    if (Platform.isAndroid) {
      image = image_lib.copyRotate(image, -90);//-90);
